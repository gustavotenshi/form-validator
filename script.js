...
class ValidaFormulário {
  ...
  validaUsuario(campo) {
    ...
    if(usuario.length < 3 || usuario.length > 12) {
      this.criaErro(campo, 'Usuário deverá conter entre 3 e 12 caracteres')
      valid = false;
    }

    if(!usuario.match(/^[a-zA-Z0-9]+$/g)) {
      this.criaErro(campo, 'Usuário só poderá conter letra e/ou números')
      valid = false;
    }
...
let valida = new ValidaFormulário();
